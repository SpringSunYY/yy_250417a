  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="supplierInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编号" align="center" v-if="columns[0].visible" prop="supplierId" />
        ...
        <el-table-column label="审核人" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible" prop="auditUserId" />
        <el-table-column label="审核描述" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible" prop="auditDesc" />
        <el-table-column label="创建时间" align="center" v-if="columns[5].visible" prop="createTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.createTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
        <el-table-column label="更新人" :show-overflow-tooltip="true" align="center" v-if="columns[6].visible" prop="updateBy" />
