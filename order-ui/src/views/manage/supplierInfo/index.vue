<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="状态" prop="status">
        <el-select v-model="queryParams.status" placeholder="请选择状态" clearable>
          <el-option
            v-for="dict in dict.type.audit_common_status"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-table v-loading="loading" :data="supplierInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编号" align="center" v-if="columns[0].visible" prop="supplierId"/>
      ...
      <el-table-column label="状态" align="center" v-if="columns[2].visible" prop="status">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.audit_common_status" :value="scope.row.status"/>
        </template>
      </el-table-column>
      <el-table-column label="审核人" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible"
                       prop="auditUserName"
      />
      <el-table-column label="审核描述" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible"
                       prop="auditDesc"
      />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <!--        </el-form-item>-->
        <el-form-item label="状态" prop="status" v-has-permi="['manage:supplierInfo:audit']">
        ...
        <!--        </el-form-item>-->
        <el-form-item label="审核描述" prop="auditDesc" v-has-permi="['manage:supplierInfo:audit']">
          <el-input v-model="form.auditDesc" placeholder="请输入审核描述"/>
        </el-form-item>
...
import {
  ...
  addSupplierInfo,
  updateSupplierInfo
} from '@/api/manage/supplierInfo'

export default {
  name: 'SupplierInfo',
  dicts: ['audit_common_status'],
  data() {
    return {
      //表格展示列
      columns: [
        ...
        { key: 3, label: '审核人', visible: true },
        { key: 4, label: '审核描述', visible: true },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除供应商申请编号为"' + supplierIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('manage/supplierInfo/export', {
        ...this.queryParams
