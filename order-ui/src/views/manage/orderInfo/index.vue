  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="orderInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编号" align="center" v-if="columns[0].visible" prop="orderId" />
        ...
        <el-table-column label="价格" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible" prop="totalPrice" />
        <el-table-column label="状态" align="center" v-if="columns[4].visible" prop="historyStatus">
